...
| L14 | Hemoglobin decrease | S3 | HGB decrease (required) | HGB: ≥2× control → S3 Adverse | Hematology |
| L15 | RBC decrease | S3 | RBC decrease (required) | RBC: ≥2× control → S3 Adverse | Hematology |
| L16 | HCT decrease | S2 | HCT decrease (required) | HCT: ≥1.5× control → S2 Concern | Hematology |
| L17 | Platelet decrease | S3 | PLAT decrease (required) | PLAT: ≥2× control → S3 Adverse | Hematology |
| L18 | WBC decrease | S2 | WBC decrease (required) | WBC: ≥1.5× control → S2 Concern | Hematology |
| L19 | Neutrophil decrease | S3 | NEUT decrease (required) | NEUT: ≥2× control → S3 Adverse | Hematology |
...
| L25c | Urinalysis abnormality | S1 | URINE_VOL increase (required); URINE_SG decrease (supporting) | URINE_VOL: ≥1.5× control → S1 Monitor; URINE_SG: ≥1.3× control → S1 Monitor | Urinalysis |
...
| L31 | Reticulocyte decrease | S2 | RETIC decrease (required) | RETIC: ≥2× control → S2 Concern | Hematology |
...
| Role | Term | Status | Matched Endpoint | Domain | Dir | Effect Size (d) | p-value | Fold Change | Pattern |
|------|------|--------|------------------|--------|-----|-----------------|---------|-------------|---------|
| **R** | NEUT ↓ | ✓ matched | Neutrophils | LB | ↓ | +2.45 | 0.0003 | 1.51× | threshold_decrease |
| **R** | PLAT ↓ | ○ not sig | Platelets | LB | ↑ | +1.06 | 0.091 | 1.13× | non_monotonic |
| **R** | RBC ↓ | ✓ matched | Erythrocytes | LB | ↓ | +1.43 | 0.040 | 1.04× | non_monotonic |
| **R** | HGB ↓ | ✓ matched | Hemoglobin | LB | ↓ | +2.64 | <0.0001 | 1.10× | threshold_decrease |
...
| S | Body Weight ↓ | ✓ matched | Body Weight | BW | ↓ | +8.15 | <0.0001 | 1.24× | threshold_decrease |
...
| Role | Term | Status | Matched Endpoint | Domain | Dir | Effect Size (d) | p-value | Fold Change | Pattern |
|------|------|--------|------------------|--------|-----|-----------------|---------|-------------|---------|
| **R** | Body Weight ↓ | ✓ matched | Body Weight | BW | ↓ | +8.15 | <0.0001 | 1.24× | threshold_decrease |
| S | Food Consumption ↓ | — not measured | — | BW | — | n/a | n/a | n/a | — |
| S | Organ weight ↓ | ✓ matched | HEART — HEART (WEIGHT) | OM | ↓ | +2.72 | <0.0001 | 1.48× | threshold_decrease |
...
| **R** | RRAG | ✓ matched | RR Interval, Aggregate | EG | ↓ | +1.09 | 0.104 | 1.24× | threshold_decrease |
| **R** | HR | — not measured | — | VS | — | n/a | n/a | n/a | — |
| S | Heart weight ↑ | ⚠ opposite | HEART — HEART (WEIGHT) | OM | ↓ | +2.72 | <0.0001 | 1.48× | threshold_decrease |
...
| Role | Term | Status | Matched Endpoint | Domain | Dir | Effect Size (d) | p-value | Fold Change | Pattern |
|------|------|--------|------------------|--------|-----|-----------------|---------|-------------|---------|
| **R** | WBC ↓ | ✓ matched | Leukocytes | LB | ↓ | +2.08 | 0.003 | 1.69× | threshold_decrease |
