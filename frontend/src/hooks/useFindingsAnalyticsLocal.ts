...
function computeAnalyticsSync(
  ...
  // sex-discordance guard (research/brain-concordance-guard.md). resolveOrganBand
  // is called twice per endpoint (here + inside getSexConcordanceBoost); regex +
  // set lookups are O(1), negligible at typical 100-300 endpoints.
