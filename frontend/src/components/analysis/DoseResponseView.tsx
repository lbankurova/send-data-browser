...
import { Loader2, TrendingUp, GitBranch, ScatterChart, Link2, BoxSelect, Pin, Plus, Search, Scale } from "lucide-react";
import {
  useReactTable,
  getCoreRowModel,
  getSortedRowModel,
...
import { CausalityWorksheet } from "@/components/analysis/panes/CausalityWorksheet";
