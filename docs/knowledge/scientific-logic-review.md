...
| S4 | Critical | Treatment-related mortality (non-syndrome organs) |
...
All p-values and effect sizes in this document are computed by the backend analysis engine. Method documentation: `docs/knowledge/methods.md`.

### Test Assignment by Endpoint Type
...
- Williams' test (optimal for monotonic dose-response) and Steel's test (nonparametric many-to-one) are not implemented.
- Dunnett's test is computed but not used in classification logic (supplementary evidence only).
- MI severity grades (1–5) have no formal ordinal test applied in the active pipeline.
- No multiplicity correction within domains for incidence tests.
...
|-----------|--------|--------|
| Certainty | `mechanism_uncertain` | Required findings met. But ALP argues against this specific mechanism. Consider differential (XS02 (Cholestatic injury)). Liver enzyme tier: watchlist (max FC 1.6×). Capped at pattern_only, lifted 2 level(s) to mechanism_uncertain by upgrade evidence (score 3.0: UE-01, UE-04, UE-05, UE-06). Adaptive pattern: liver weight increase + hypertrophy without necrosis/degeneration suggests enzyme induction (non-adverse). ALT/AST fold change < 5×. |
| Enzyme tier | `watchlist` → `mechanism_uncertain` | Score 3.0, lifted 2 level(s). Met: UE-01, UE-04, UE-05, UE-06 |
...
| LIVER — LIVER (WEIGHT) | n=10, 6.885±0.964 | n=10, 13.092±3.600 (dose 3) |
...
| Role | Term | Status | Matched Endpoint | Domain | Dir | Effect Size (g) | p-value | Fold Change | Pattern |
|------|------|--------|------------------|--------|-----|-----------------|---------|-------------|---------|
| **R** | Adrenal weight ↑ | ✓ matched | GLAND, ADRENAL — GLAND, ADRENAL (WEIGHT) | OM | ↑ | +1.68 | 0.004 | 1.05× | threshold_increase |
...
| **R** | Body Weight ↓ | ✓ matched | Body Weight | BW | ↓ | -7.80 | <0.0001 | 0.81× | threshold_decrease |
...
| THYMUS_WT | ↓ | ↓ | supports | moderate |

**Group statistics (REM-05):**

| Endpoint | Control (n, mean±SD) | Worst Treated (n, mean±SD, dose) |
|----------|---------------------|----------------------------------|
| GLAND, ADRENAL — GLAND, ADRENAL (WEIGHT) | n=10, 0.086±0.016 | n=10, 0.122±0.024 (dose 3) |
...
| Endpoint | Control (n, mean±SD) | Worst Treated (n, mean±SD, dose) |
|----------|---------------------|----------------------------------|
| HEART — HEART (WEIGHT) | n=9, 1.463±0.172 | n=9, 0.989±0.183 (dose 3) |
...
## XC03a: Thyroid FCHH (Enzyme Induction) [DETECTED]

**Confidence:** LOW  
**Domains covered:** MI, OM  
**Sexes:** F  
**Required logic met:** No (0/2 required terms, logic: T4 + TSH)
...
| Role | Term | Status | Matched Endpoint | Domain | Dir | Effect Size (g) | p-value | Fold Change | Pattern |
|------|------|--------|------------------|--------|-----|-----------------|---------|-------------|---------|
| **R** | T4 ↓ | — not measured | — | LB | — | n/a | n/a | n/a | — |
| **R** | TSH ↑ | — not measured | — | LB | — | n/a | n/a | n/a | — |
| S | Thyroid hypertrophy, follicular cell | — not measured | — | MI | — | n/a | n/a | n/a | — |
| S | Liver hypertrophy | ✓ matched | LIVER — HYPERTROPHY | MI | ↑ | n/a | 0.003 | n/a | threshold_increase |
| S | Thyroid weight ↑ | ✓ matched | GLAND, THYROID — GLAND, THYROID (WEIGHT) | OM | ↑ | +2.15 | 0.0003 | 1.58× | threshold_increase |
| S | Liver weight ↑ | ✓ matched | LIVER — LIVER (WEIGHT) | OM | ↑ | +2.26 | <0.0001 | 1.90× | threshold_increase |
...
|--------|-------|-------|--------|
| A-1 Dose-response | strong | 2 | Strong pattern in ≥1 matched endpoint (p < 0.1 or pairwise p < 0.01 with |g| ≥ 0.8) |
| A-2 Cross-endpoint concordance | concordant | 1 | Concordant across MI, OM (2 domains) |
| A-3 HCD comparison | no_hcd | 0 | Historical control data not available |
| A-6 Statistical significance | significant | 1 | Min p-value: 0.0000 → significant |
| A-7 Clinical observation support | no | 0 | No supporting clinical observations |
...
| Endpoint | Control (n, mean±SD) | Worst Treated (n, mean±SD, dose) |
|----------|---------------------|----------------------------------|
| GLAND, THYROID — GLAND, THYROID (WEIGHT) | n=10, 0.021±0.003 | n=10, 0.033±0.007 (dose 2) |
| LIVER — LIVER (WEIGHT) | n=10, 6.885±0.964 | n=10, 13.092±3.600 (dose 3) |

---

## XC04c: Adrenal Cortical Vacuolation (Steroidogenesis Block) [DETECTED]

**Confidence:** LOW  
**Domains covered:** LB, OM  
**Sexes:** F, M  
**Required logic met:** No (0/1 required terms, logic: ADRENAL_MI)
...
| Role | Term | Status | Matched Endpoint | Domain | Dir | Effect Size (g) | p-value | Fold Change | Pattern |
|------|------|--------|------------------|--------|-----|-----------------|---------|-------------|---------|
| **R** | Adrenal vacuolation, cortical | — not measured | — | MI | — | n/a | n/a | n/a | — |
| S | CORT ↓ | — not measured | — | LB | — | n/a | n/a | n/a | — |
| S | ACTH ↑ | — not measured | — | LB | — | n/a | n/a | n/a | — |
| S | K ↑ | ✓ matched | Potassium | LB | ↑ | +1.06 | 0.040 | 1.11× | threshold_increase |
| S | SODIUM ↓ | ✓ matched | Sodium | LB | ↓ | -1.40 | 0.016 | 0.98× | non_monotonic |
| S | Adrenal weight | ✓ matched | GLAND, ADRENAL — GLAND, ADRENAL (WEIGHT) | OM | ↑ | +1.68 | 0.004 | 1.05× | threshold_increase |
...
| A-3 HCD comparison | no_hcd | 0 | Historical control data not available |
| A-6 Statistical significance | significant | 1 | Min p-value: 0.0036 → significant |
| A-7 Clinical observation support | no | 0 | No supporting clinical observations |
...
| Endpoint | Control (n, mean±SD) | Worst Treated (n, mean±SD, dose) |
|----------|---------------------|----------------------------------|
| Potassium | n=10, 4.880±0.394 | n=10, 5.420±0.637 (dose 1) |
| Sodium | n=9, 144.444±1.424 | n=10, 142.200±1.619 (dose 2) |
| GLAND, ADRENAL — GLAND, ADRENAL (WEIGHT) | n=10, 0.086±0.016 | n=10, 0.122±0.024 (dose 3) |
...
| Endpoint | Control (n, mean±SD) | Worst Treated (n, mean±SD, dose) |
|----------|---------------------|----------------------------------|
| Creatinine | n=9, 0.232±0.022 | n=9, 0.291±0.041 (dose 3) |
| KIDNEY — KIDNEY (WEIGHT) | n=10, 1.802±0.167 | n=10, 2.756±0.466 (dose 3) |
...
| Endpoint | Control (n, mean±SD) | Worst Treated (n, mean±SD, dose) |
|----------|---------------------|----------------------------------|
| Leukocytes | n=9, 10.034±2.559 | n=9, 5.933±1.096 (dose 3) |
| THYMUS — THYMUS (WEIGHT) | n=10, 0.414±0.113 | n=10, 0.293±0.103 (dose 1) |
...
## XC01a: BM Myeloid Suppression [DETECTED]

**Confidence:** LOW  
**Domains covered:** LB  
**Sexes:** M  
**Required logic met:** Yes (1/1 required terms, logic: NEUT)
...
|------|------|--------|------------------|--------|-----|-----------------|---------|-------------|---------|
| **R** | NEUT ↓ | ✓ matched | Neutrophils | LB | ↓ | -2.34 | 0.0004 | 0.66× | threshold_decrease |
| S | WBC ↓ | ✓ matched | Leukocytes | LB | ↓ | -1.98 | <0.0001 | 0.59× | threshold_decrease |
| S | Bone marrow decreased cellularity | — not measured | — | MI | — | n/a | n/a | n/a | — |
| S | Spleen weight ↓ | ⚠ opposite | SPLEEN — SPLEEN (WEIGHT) | OM | ↑ | +1.42 | 0.005 | 1.43× | threshold_increase |
