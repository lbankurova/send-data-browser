...
| STAT-03 | Boschloo's Exact (2x2) | Pairwise incidence rates, binary endpoints (Fisher's as override) |
...
| CLASS-10 | Recovery Verdict (Histopath/Incidence) | Reversed/persisted/progressed classification |
| CLASS-10b | Recovery Verdict (Continuous) | Signed Hedges' g trajectory — **audit: sign-flip blind spot, no dose-response context** (`docs/knowledge/continuous-recovery-verdict-audit.md`) |
