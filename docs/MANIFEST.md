...
| Asset | Depends on | Last validated | Status |
|-------|-----------|----------------|--------|
| `TODO.md` | All system specs | 2026-02-09 | Current — FEAT-07 superseded, FEAT-02 consolidated |
