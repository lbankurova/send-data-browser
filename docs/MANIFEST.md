...
| `views/adverse-effects.md` | `frontend/src/components/analysis/findings/AdverseEffectsView.tsx`, `frontend/src/components/analysis/FindingsTable.tsx`, `frontend/src/components/analysis/FindingsFilterBar.tsx`, `frontend/src/components/analysis/panes/AdverseEffectsContextPanel.tsx`, `frontend/src/components/analysis/panes/SyndromeContextPanel.tsx`, `frontend/src/components/analysis/panes/FindingsContextPanel.tsx`, `frontend/src/components/analysis/panes/OrganContextPanel.tsx`, `frontend/src/components/analysis/panes/RecoveryPane.tsx`, `frontend/src/lib/organ-proportionality.ts`, `frontend/src/lib/cross-domain-syndromes.ts`, `frontend/src/lib/syndrome-interpretation.ts`, `frontend/src/lib/organ-weight-normalization.ts`, `frontend/src/lib/endpoint-confidence.ts`, `frontend/src/hooks/useOrganWeightNormalization.ts`, `frontend/src/hooks/useNormalizationOverrides.ts`, `frontend/src/hooks/useAdverseEffects.ts`, `frontend/src/hooks/useAESummary.ts`, `frontend/src/components/analysis/findings/FindingsRail.tsx`, `backend/routers/annotations.py`, `backend/routers/analyses.py`, `backend/services/analysis/*.py` | 2026-02-26 | Current — Phase F: normalization override UI in OrganContextPanel (mode selector, reason textarea, audit trail). Phase E ANCOVA retained. |
