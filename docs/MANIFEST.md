...
| `views/histopathology.md` | `frontend/src/components/analysis/HistopathologyView.tsx`, `frontend/src/components/analysis/panes/HistopathologyContextPanel.tsx`, `frontend/src/hooks/useLesionSeveritySummary.ts`, `frontend/src/hooks/useHistopathSubjects.ts`, `frontend/src/hooks/useRuleResults.ts`, `frontend/src/lib/severity-colors.ts`, `frontend/src/hooks/useResizePanel.ts`, `frontend/src/components/ui/PanelResizeHandle.tsx`, `frontend/src/components/ui/EvidenceBar.tsx` | 2026-02-11 | Current — v2 Phase 1+2 complete: 14 UX refinements (state resets, structured metrics, coherence card, risk-density sort, dose ramp bars, subject sort, incidence info icon) |
