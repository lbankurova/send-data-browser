...
| `knowledge/methods.md` | `frontend/src/lib/*.ts`, `backend/generator/*.py`, `backend/services/analysis/*.py` | 2026-02-25 | Current — analytical methods registry (STAT-*, CLASS-*, METRIC-*, METH-*, DATA-*). CLASS-22 through CLASS-27 added for ECI (non-monotonic detection, trend validity, normalization ceiling, integrated confidence, NOAEL contribution weight, weighted NOAEL derivation). |
