...
| `knowledge/methods.md` | `frontend/src/lib/*.ts`, `backend/generator/*.py`, `backend/services/analysis/*.py` | 2026-02-28 | Current — analytical methods registry (STAT-*, CLASS-*, METRIC-*, METH-*, DATA-*). METH-36 (B-6 progression chains) added for Tier 3B. |
...
| `incoming/arch-overhaul/TOPIC-assessment-engine.md` | ECETOC assessment engine roadmap, Tiers 1+2+3A+3B shipped, HCD Phase 2 SQLite shipped, regulatory alignment, gap analysis, deep research briefs | 2026-03-01 | Current — HCD Phase 2 (SQLite from NTP DTT IAD) shipped |
