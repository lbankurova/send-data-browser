...
|-------|------------------------|----------------|--------|
| `systems/insights-engine.md` | `frontend/src/lib/signals-panel-engine.ts`, `frontend/src/lib/rule-synthesis.ts`, `frontend/src/lib/finding-aggregation.ts`, `frontend/src/components/analysis/panes/InsightsList.tsx`, `frontend/src/components/analysis/SignalsPanel.tsx`, `backend/generator/scores_and_rules.py`, `backend/generator/view_dataframes.py`, `backend/services/analysis/clinical_catalog.py` | 2026-02-09 | STALE — clinical catalog post-pass (C01-C15, PEX01-PEX07) not yet documented in system spec |
