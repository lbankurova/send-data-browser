...
| `systems/data-pipeline.md` | `backend/generator/generate.py`, `backend/generator/domain_stats.py`, `backend/generator/view_dataframes.py`, `backend/generator/scores_and_rules.py`, `backend/generator/organ_map.py`, `backend/services/xpt_processor.py`, `backend/services/analysis/findings_pipeline.py`, `backend/services/analysis/*.py`, `frontend/src/lib/stat-method-transforms.ts`, `frontend/src/hooks/useStatMethods.ts`, `frontend/src/hooks/useFindingsAnalyticsLocal.ts` | 2026-02-26 | Current — findings_pipeline.py extracted: shared enrichment for generator + API, content-hash cache, finding_key with collision detection. |
...
| `knowledge/api-field-contracts.md` | `backend/generator/generate.py`, `backend/generator/view_dataframes.py`, `backend/generator/scores_and_rules.py`, `backend/generator/domain_stats.py`, `backend/services/analysis/classification.py`, `backend/services/analysis/dose_groups.py`, `backend/services/analysis/mortality.py`, `backend/generator/tumor_summary.py`, `backend/generator/food_consumption_summary.py`, `backend/generator/pk_integration.py`, `backend/services/analysis/adaptive_trees.py` | 2026-02-28 | Current — 75 fields (BFIELD-01–BFIELD-75). Tier 2: _assessment_detail (BFIELD-74), _tree_result (BFIELD-75). |
| `knowledge/methods.md` | `frontend/src/lib/*.ts`, `backend/generator/*.py`, `backend/services/analysis/*.py` | 2026-02-28 | Current — analytical methods registry (STAT-*, CLASS-*, METRIC-*, METH-*, DATA-*). METH-33 (two-gate OM), METH-34 (adaptive decision trees) added for Tier 2. |
...
| `incoming/arch-overhaul/TOPIC-assessment-engine.md` | ECETOC assessment engine roadmap, Tier 1+2 shipped, regulatory alignment, gap analysis, deep research briefs | 2026-02-28 | Current — Tiers 1+2 shipped, adaptive trees, two-gate OM |
