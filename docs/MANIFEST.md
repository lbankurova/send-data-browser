...
| `incoming/arch-overhaul/TOPIC-assessment-engine.md` | ECETOC assessment engine roadmap, Tiers 1+2+3A shipped, regulatory alignment, gap analysis, deep research briefs | 2026-02-28 | Current — Tiers 1+2 shipped, Tier 3A Phase 1 (A-3 HCD static ranges) shipped |
