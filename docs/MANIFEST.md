...
| Asset | Depends on (code files) | Last validated | Status |
|-------|------------------------|----------------|--------|
| `views/study-summary.md` | `frontend/src/components/analysis/StudySummaryView.tsx`, `frontend/src/components/analysis/StudySummaryViewWrapper.tsx`, `frontend/src/components/analysis/SignalsPanel.tsx`, `frontend/src/components/analysis/StudySummaryFilters.tsx`, `frontend/src/components/analysis/charts/OrganGroupedHeatmap.tsx`, `frontend/src/components/analysis/panes/StudySummaryContextPanel.tsx`, `frontend/src/lib/signals-panel-engine.ts`, `frontend/src/hooks/useInsights.ts` | 2026-02-14 | Current — Added: Protective Signals Bar, Rules tab, context panel wrapper architecture, TRUST panes (Source Records, Audit Trail, Methodology) |
| `views/dose-response.md` | `frontend/src/components/analysis/DoseResponseView.tsx`, `frontend/src/components/analysis/DoseResponseViewWrapper.tsx`, `frontend/src/components/analysis/DoseResponseEndpointPicker.tsx`, `frontend/src/components/analysis/panes/DoseResponseContextPanel.tsx`, `frontend/src/hooks/useDoseResponseMetrics.ts`, `frontend/src/hooks/useClinicalObservations.ts`, `frontend/src/hooks/useTimecourse.ts`, `frontend/src/lib/analysis-definitions.ts` | 2026-02-14 | Current — Layout corrected: dropdown endpoint picker (not left-panel rail), wrapper simplified, nav links updated |
| `views/target-organs.md` | `frontend/src/components/shell/OrganRailMode.tsx`, `frontend/src/components/analysis/panes/TargetOrgansContextPanel.tsx`, `frontend/src/contexts/StudySelectionContext.tsx`, `frontend/src/contexts/RailModeContext.tsx`, `frontend/src/hooks/useTargetOrganSummary.ts`, `frontend/src/hooks/useOrganEvidenceDetail.ts`, `frontend/src/hooks/useRuleResults.ts`, `frontend/src/lib/organ-analytics.ts` | 2026-02-14 | Current — Major rewrite: no center-panel view exists (route redirects to study summary), all organ functionality in shell-level OrganRailMode + context panel |
...
| `views/noael-decision.md` | `frontend/src/components/analysis/NoaelDecisionView.tsx`, `frontend/src/components/analysis/NoaelDecisionViewWrapper.tsx`, `frontend/src/components/analysis/panes/NoaelContextPanel.tsx`, `frontend/src/hooks/useAdverseEffectSummary.ts`, `frontend/src/hooks/useRuleResults.ts`, `frontend/src/contexts/StudySelectionContext.tsx`, `frontend/src/hooks/useRailModePreference.ts` | 2026-02-14 | Current — Architecture corrected: uses shell-level OrganRailMode (not embedded rail), duplicate empty state bug documented |
| `views/adverse-effects.md` | `frontend/src/components/analysis/AdverseEffectsView.tsx`, `frontend/src/components/analysis/FindingsTable.tsx`, `frontend/src/components/analysis/panes/AdverseEffectsContextPanel.tsx`, `frontend/src/hooks/useAdverseEffects.ts`, `frontend/src/hooks/useAESummary.ts`, `backend/routers/analyses.py`, `backend/services/analysis/*.py` | 2026-02-14 | Current — Verified compliant, no changes needed |
| `views/validation.md` | `frontend/src/components/analysis/ValidationView.tsx`, `frontend/src/components/analysis/ValidationRuleCatalog.tsx`, `frontend/src/components/analysis/panes/ValidationContextPanel.tsx`, `frontend/src/components/analysis/panes/ValidationIssueForm.tsx`, `frontend/src/hooks/useValidationResults.ts`, `frontend/src/hooks/useAffectedRecords.ts`, `frontend/src/hooks/useRunValidation.ts`, `backend/validation/engine.py`, `backend/routers/validation.py` | 2026-02-14 | Current — Rule catalog mode (third tab) documented |
