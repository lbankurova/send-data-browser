...
| `knowledge/methods.md` | `frontend/src/lib/*.ts`, `backend/generator/*.py`, `backend/services/analysis/*.py` | 2026-02-23 | Current — analytical methods registry (STAT-*, CLASS-*, METRIC-*, METH-*, DATA-*). METH-03a (organ weight normalization auto-selection) added. |
