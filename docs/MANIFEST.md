...
| `incoming/arch-overhaul/TOPIC-assessment-engine.md` | ECETOC assessment engine roadmap, Tiers 1+2+3A+3B shipped, regulatory alignment, gap analysis, deep research briefs | 2026-02-28 | Current — Tier 3B (B-6 progression chains) shipped |
