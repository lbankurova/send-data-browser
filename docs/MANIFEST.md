...
| Asset | Depends on (code files) | Last validated | Status |
|-------|------------------------|----------------|--------|
| `views/study-summary.md` | `frontend/src/components/analysis/StudySummaryView.tsx`, `frontend/src/components/analysis/StudySummaryViewWrapper.tsx`, `frontend/src/components/analysis/charts/StudyTimeline.tsx`, `frontend/src/components/analysis/panes/StudyDetailsContextPanel.tsx`, `frontend/src/hooks/useInsights.ts`, `frontend/src/hooks/useStudySummaryTab.ts` | 2026-02-22 | Current — Major redesign: Signals tab removed (content merged into NOAEL view), 2 tabs (Details + Cross-Study), Study Profile Block with TK/NOAEL summary, StudyTimeline SVG, Data Quality section moved from context panel to main panel, domain record counts added |
