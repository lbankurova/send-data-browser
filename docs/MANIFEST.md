...
| `knowledge/methods.md` | `frontend/src/lib/*.ts`, `backend/generator/*.py`, `backend/services/analysis/*.py` | 2026-03-01 | Current — analytical methods registry (STAT-*, CLASS-*, METRIC-*, METH-*, DATA-*). METH-14 updated for 33 syndromes (XS+XC). METH-38 (cross-organ chain detection) added for Brief 3. |
