...
| Asset | Status | Notes |
|-------|--------|-------|
| `incoming/send-study-intelligence-prompt.md` | Phases 1-6 complete (2026-02-11) | Cross-study intelligence with dual-layer data (reported/derived). Landing page table + adaptive context panel ✅. All 19 rules (0-18) ✅. Insights tab ✅. Phase 7 pending (routing integration). |
| `incoming/IMPLEMENTATION_PLAN_study_intelligence_v2.md` | Phases 1-6 complete (2026-02-11) | Phase 1-5 ✅. Phase 6: Cross-Study Insights tab on Study Details page ✅. Priority filtering, InsightCard component, useInsights hook integration. Phase 7 pending. |
