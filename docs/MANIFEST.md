...
| Asset | Depends on (code files) | Last validated | Status |
|-------|------------------------|----------------|--------|
| `views/study-summary.md` | `frontend/src/components/analysis/StudySummaryView.tsx`, `frontend/src/components/analysis/StudySummaryViewWrapper.tsx`, `frontend/src/components/analysis/SignalsPanel.tsx`, `frontend/src/components/analysis/StudySummaryFilters.tsx`, `frontend/src/components/analysis/charts/OrganGroupedHeatmap.tsx`, `frontend/src/components/analysis/panes/StudySummaryContextPanel.tsx`, `frontend/src/lib/signals-panel-engine.ts`, `frontend/src/hooks/useInsights.ts`, `frontend/src/lib/protective-signal.ts` | 2026-02-16 | Current — Synced: session-persisted state (tab, evidence tab, sorting, column sizing), treatment arms table (text-[10px], px-1.5 py-px, border-l-2 dose color), protective signals bar rewritten (pharmacological/treatment-decrease/background classification), metrics tab content-hugging + absorber pattern, severity colored text (not badge) in top findings, Generate Report button full classes |
